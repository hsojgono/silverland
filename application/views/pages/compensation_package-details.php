        ...
        <div class="box-body box-profile">
            <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                    <b>Position:</b> <a class="pull-right"><?php echo $compensation_package['position_name']; ?></a>
                </li>
                <li class="list-group-item">
                    <b>Monthly Salary:</b> <a class="pull-right"><?php echo $compensation_package['monthly_salary']; ?></a>
                </li>
                <li class="list-group-item">
                    <b>Status:</b> <a class="pull-right"><?php echo $compensation_package['status_label']; ?></a>
                </li>
                <li class="list-group-item">
                    <b>Created:</b> <a class="pull-right"><?php echo date('F d, Y', strtotime($compensation_package['cp_created'])); ?></a>
                </li>
            </ul>
        </div>
    </div>
