    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <form class="form-inline" action="<?php echo site_url('employee_sss/load'); ?>" method="post">
                    <!-- <div class="pull-left">
                        <i class="fa fa-list"></i> <h3 class="box-title">List of Employee Taxes</h3>
                    </div> -->
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped table-hover" id="datatables-employee-sss">
                    <thead>
                        <tr>
                            <!-- <th style="width: 250px;">&nbsp;</th> -->
                            <th class="text-left">Company</th>
                            <th class="text-left">Employee</th>
                            <th class="text-left">SSS Number</th>
                    ...
                    <tbody>
                        <?php if ( ! empty($social_securities)): ?>
                            <?php foreach ($social_securities as $sss): ?>
                                <tr>
                                    <td class="text-left"><?php echo $sss['company_name']; ?></td>
                                    <td class="text-left"><?php echo $sss['full_name']; ?></td>
                                    <td class="text-right"><?php echo $sss['sss']; ?></td>
                                    <td class="text-left"><?php echo $current_month . ' ' . $current_year; ?></td>
                                    <td class="text-right"><?php echo $sss['sss_employee']; ?></td>
                                    <td class="text-right"><?php echo $sss['sss_employer']; ?></td>
                                    <td class="text-right"><?php echo $sss['sss_amount']; ?></td>
                                </tr>
                                <div class="modal fade" id="update-sss-status-<?php echo md5($sss['id']); ?>" role="dialog">
                                 ...
                                 <div class="modal fade" id="update-sss-<?php echo md5($sss['id']); ?>" role="dialog">
                                    <div class="modal-dialog">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <!-- http://localhost/kawani_ci/roles/update_status/1 -->
