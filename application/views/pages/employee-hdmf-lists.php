    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <form class="form-inline" action="<?php echo site_url('employee_hdmfs/load'); ?>" method="post">
                    <!-- <div class="pull-left">
                        <i class="fa fa-list"></i> <h3 class="box-title">List of Employee Taxes</h3>
                    </div> -->
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped table-hover" id="datatables-employee-hdmf">
                    <thead>
                        <tr>
                            <!-- <th style="width: 250px;">&nbsp;</th> -->
                            <th class="text-left">Company</th>
                            <th class="text-left">Employee</th>
                            <th class="text-left">HDMF Number</th>
                    ...
                    <tbody>
                        <?php if ( ! empty($hdmfs)): ?>
                            <?php foreach ($hdmfs as $hdmf): ?>
                                <tr>
                                    <td class="text-left"><?php echo $hdmf['company_name']; ?></td>
                                    <td class="text-left"><?php echo $hdmf['full_name']; ?></td>
                                    <td class="text-right"><?php echo $hdmf['hdmf']; ?></td>
                                    <td class="text-left"><?php echo $current_month . ' ' . $current_year; ?></td>
                                    <td class="text-right"><?php echo $hdmf['hdmf_employee']; ?></td>
                                    <td class="text-right"><?php echo $hdmf['hdmf_employer']; ?></td>
                                    <td class="text-right"><?php echo $hdmf['hdmf_amount']; ?></td>
                                </tr>
                                <div class="modal fade" id="update-hdmf-status-<?php echo md5($hdmf['id']); ?>" role="dialog">
                                 ...
                                 <div class="modal fade" id="update-hdmf-<?php echo md5($hdmf['id']); ?>" role="dialog">
                                    <div class="modal-dialog">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <!-- http://localhost/kawani_ci/roles/update_status/1 -->
