    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <form class="form-inline" action="<?php echo site_url('employee_taxes/load'); ?>" method="post">
                    <!-- <div class="pull-left">
                        <i class="fa fa-list"></i> <h3 class="box-title">List of Employee Taxes</h3>
                    </div> -->
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped table-hover" id="datatables-employee-taxes">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if ( ! empty($taxes)): ?>
                            <?php foreach ($taxes as $tax): ?>
                                <tr>
                                    <td class="text-left"><?php echo $tax['company_name']; ?></td>
                                    <td class="text-left"><?php echo $tax['full_name']; ?></td>
                                    <td class="text-left"><?php echo $tax['tin']; ?></td>
                                    <td class="text-left"><?php echo $current_month . ' ' . $current_year; ?></td>
                                    <td class="text-left"><?php echo $tax['tax']; ?></td>
                                    <td class="text-left"><?php echo $tax['tax_ytd']; ?></td>
                                </tr>
                                <div class="modal fade" id="update-tax-status-<?php echo md5($tax['id']); ?>" role="dialog">
                                 ...
                                 <div class="modal fade" id="update-tax-<?php echo md5($tax['id']); ?>" role="dialog">
                                    <div class="modal-dialog">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <!-- http://localhost/kawani_ci/roles/update_status/1 -->
