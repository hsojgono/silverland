<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo site_url('benefits/edit/'.$benefit['id']); ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <select class="form-control select2 col-xs-3 col-md-3 col-sm-3 col-lg-3" name="benefit_matrix_id" id="benefit_matrix_id">
                                <option value="<?php echo $benefit['benefit_matrix_id']; ?>"><?php echo $benefit['effectivity_date']; ?></option>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="name" type="text" name="name" class="form-control" value="<?php echo $benefit['name']; ?>">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="amount" type="text" name="amount" class="form-control" value="<?php echo  $benefit['amount']; ?>">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="description" type="text" name="description" class="form-control" value="<?php echo  $benefit['description']; ?>">
