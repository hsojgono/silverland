    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <i class="fa fa-pencil-square-o"></i> <h3 class="box-title">Edit Employee Loan</h3>
            </div>
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo site_url('employee_loans/edit/'. $loan['employee_loan_id']); ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <select class="form-control select2 col-xs-3 col-md-3 col-sm-3 col-lg-3" name="employee_id" id="employee_id">
                                <option value="<?php echo $loan['employee_id']; ?>"><?php echo $loan['full_name']; ?></option>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <select class="form-control select2 col-xs-3 col-md-3 col-sm-3 col-lg-3" name="loan_type_id" id="loan_type_id">
                                <option value="<?php echo $loan['loan_type_id']; ?>"><?php echo $loan['loan_type']; ?></option>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="interest_per_month" type="text" name="interest_per_month" class="form-control" value="<?php echo $loan['interest_per_month']; ?>" readonly="readonly">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="loan_amount" type="text" name="loan_amount" class="form-control" value="<?php echo $loan['loan_amount']; ?>" onkeypress="validate(event)">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="months_to_pay" type="text" name="months_to_pay" class="form-control" value="<?php echo $loan['months_to_pay']; ?>">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="amount_interest" type="text" name="amount_interest" class="form-control" value="<?php echo $loan['amount_interest']; ?>" readonly="readonly">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="total_amount" type="text" name="total_amount" class="form-control" value="<?php echo $loan['total_amount']; ?>" readonly="readonly">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input id="monthly_amortization" type="text" name="monthly_amortization" class="form-control" value="<?php echo $loan['monthly_amortization']; ?>" readonly="readonly">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <textarea name="reason" class="form-control" rows="4" cols="40"><?php echo $loan['reason']; ?></textarea>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" id="date_start" name="date_start" class="form-control pull-right datepicker" value="<?php echo date('Y-m-d', strtotime($loan['date_start'])); ?>">
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                <input type="text" id="maturity_date" name="maturity_date" class="form-control pull-right datepicker" value="<?php echo date('Y-m-d', strtotime($loan['maturity_date'])); ?>">
                            </div>
                            <div class="validation_error"><?php echo form_error('maturity_date'); ?></div>
                        </div>
                    </div>
                    <input type="hidden" name="interest" id="interest" value="<?php echo $loan['interest_per_month']; ?>">
                    <div class="form-group">
