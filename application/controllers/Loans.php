...
class Loans extends MY_Controller {
    ...
    function index()
    {
        $loans = $this->loan_model->get_loan_all();
        // // $loans = $this->loan_model->get_loan_by(['employee_loans.id' => $id]);
        // $loans = $this->loan_model->get_loan_by(['employee_loans.id']);        
        // $employee_infos = $this->employee_info_model->get_employee_info_all(['employee_information.employee_id']);
        $employees = $this->employee_model->get_employee_all();     
        // dump($employee_infos);exit;


        $this->data = array(
            'page_header' => 'Loan Management',
            'employees' => $employees,
            'loans' => $loans,
            // 'employee_infos' => $employee_infos,
            'active_menu' => $this->active_menu,
        );
        $this->load_view('pages/loan-lists');
    }
